...
public class Main {
    ...
    static private void test3() {
        ...
        op.div(0);
        op.div(1);
        System.out.println(op.rezultat); //13
        op.mult(2);
        System.out.println(op.rezultat);  //26
        op.minus(3);
        System.out.println(op.rezultat);  //23
        op.plus(7);
        System.out.println(op.rezultat); //30
    }
